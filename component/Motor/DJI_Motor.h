...
typedef enum {
    /* 底盘电机接收模块 */
    CAN_CHASSIS_MOTOR_RF_DRIVE=0x207,          //1     前右
    CAN_CHASSIS_MOTOR_LF_DRIVE=0x208,          //2     前左
    ...
    // CAN_CHASSIS_MOTOR_RF_DRIVE=0x203,          //1     前右
    // CAN_CHASSIS_MOTOR_LF_DRIVE=0x204,          //1     前左
    // CAN_CHASSIS_MOTOR_LB_DRIVE=0x201,          //2     后左
    // CAN_CHASSIS_MOTOR_RB_DRIVE=0x202,          //2     后右
    //
    // CAN_CHASSIS_MOTOR_RF_STEERING=0x207,       //1     前右
    // CAN_CHASSIS_MOTOR_LF_STEERING=0x208,       //1     前左
    // CAN_CHASSIS_MOTOR_LB_STEERING=0x205,       //2     后左
    // CAN_CHASSIS_MOTOR_RB_STEERING=0x206,       //2     后右

    /* 拨盘电机接收模块 */
    CAN_LAUNCHER_TRIGGER=0X201,                //1     拨盘

    /* 发射机构电机接收模块 */
    CAN_LAUNCHER_FIRE_LEFT=0x203,      //1     左摩擦轮
    CAN_LAUNCHER_FIRE_RIGHT=0X204,     //1     右摩擦轮

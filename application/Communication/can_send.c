...
void Send_keyboard(int16_t gimbal_mode, int16_t launcher_mode, int16_t trigger_mode, int16_t relative_up_angle) {
    uint32_t send_mail_box;
    union mode gimbal;
    union mode launcher;
    union mode trigger;
    ...
    Send_data[4] = trigger.data[0];
    Send_data[5] = trigger.data[1];

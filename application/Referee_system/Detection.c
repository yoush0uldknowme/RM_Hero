    ...
    if(offline_num==0)//所有设备在线
    {
        ...
        switch (max_level) {
            ...
            case 2:{
                ...
                if(BUZZER_REMIND_ENABLE&&detect_list[DETECT_CHASSIS_3508_RF_DRIVE].status==OFFLINE)
                {
                ...
                if(BUZZER_REMIND_ENABLE&&detect_list[DETECT_CHASSIS_3508_LF_DRIVE].status==OFFLINE)
                {
                ...
                if(BUZZER_REMIND_ENABLE&&detect_list[DETECT_CHASSIS_3508_LB_DRIVE].status==OFFLINE)
                {
                ...
                if(BUZZER_REMIND_ENABLE&&detect_list[DETECT_CHASSIS_3508_RB_DRIVE].status==OFFLINE)
                {
                ...
                if(BUZZER_REMIND_ENABLE&&detect_list[DETECT_CHASSIS_6020_RF_STEERING].status==OFFLINE)
                {
                    if(buzzer_remind_count==5)//一下
                    {
                        buzzer_remind();
                ...
                if(BUZZER_REMIND_ENABLE&&detect_list[DETECT_CHASSIS_6020_LF_STEERING].status==OFFLINE)
                {
                    if(buzzer_remind_count==5||buzzer_remind_count==10)//两下
                    {
                        buzzer_remind();
                ...
                if(BUZZER_REMIND_ENABLE&&detect_list[DETECT_CHASSIS_6020_LB_STEERING].status==OFFLINE)
                {
                    if(buzzer_remind_count==5||buzzer_remind_count==10||buzzer_remind_count==15)//三下
                    {
                        buzzer_remind();
                ...
                if(BUZZER_REMIND_ENABLE&&detect_list[DETECT_CHASSIS_6020_RB_STEERING].status==OFFLINE)
                {
                    if(buzzer_remind_count==5||buzzer_remind_count==10||buzzer_remind_count==15||buzzer_remind_count==20)//四下
                    {
                        buzzer_remind();
            ...
            case 3:{
                ...
                if(BUZZER_REMIND_ENABLE&&detect_list[DETECT_LAUNCHER_3508_FIRE_F_L].status==OFFLINE)
                {
                ...
                if(BUZZER_REMIND_ENABLE&&detect_list[DETECT_LAUNCHER_3508_FIRE_F_R].status==OFFLINE)
                {
                ...
                if(BUZZER_REMIND_ENABLE&&detect_list[DETECT_LAUNCHER_3508_FIRE_B_L].status==OFFLINE)
                {
                ...
                if(BUZZER_REMIND_ENABLE&&detect_list[DETECT_LAUNCHER_3508_FIRE_B_R].status==OFFLINE)
                {
                    if(buzzer_remind_count==5||buzzer_remind_count==10||buzzer_remind_count==15)
                    {
                        buzzer_remind();
            ...
            case 4:{
                ...
                if(BUZZER_REMIND_ENABLE&&detect_list[DETECT_GIMBAL_YAW].status==OFFLINE)
                {
                    if(buzzer_remind_count==5)
                    {
                        buzzer_remind();
                ...
                if(BUZZER_REMIND_ENABLE&&detect_list[DETECT_GIMBAL_PITCH].status==OFFLINE)
                {
                    if(buzzer_remind_count==5||buzzer_remind_count==10)
                    {
                        buzzer_remind();
...
void Detect_task(void const*pvParameters){
    ...
    for(uint8_t i=DETECT_CHASSIS_3508_RF_DRIVE;i<=DETECT_CHASSIS_6020_RB_STEERING;i++)
    ...
    detect_init(DETECT_LAUNCHER_3508_FIRE_F_L,500,3);
    detect_init(DETECT_LAUNCHER_3508_FIRE_F_R,500,3);
    detect_init(DETECT_LAUNCHER_3508_FIRE_B_L,500,3);
    detect_init(DETECT_LAUNCHER_3508_FIRE_B_R,500,3);

    detect_init(DETECT_LAUNCHER_3508_TRIGGER,500,3);

    detect_init(DETECT_GIMBAL_YAW,500,4);
    detect_init(DETECT_GIMBAL_PITCH,500,4);

...
static void Chassis_Init(void) {
    ...
    for (int i = 0; i < 4; i++) chassis.drive_motor_chassis[i].give_current = 0;
    for (int i = 0; i < 4; i++) chassis.Steering_motor_chassis[i].give_current = 0;
...
/**
  ...
  */
static void Chassis_Relax_Handle(void) {
    DJI_Send_Motor_Mapping(CAN_1,CAN_DJI_MOTOR_0x200_ID,0,0,0,0);

...
/* 修改摇杆的参数值 */
#define RC_TO_YAW       0.0008f//0.0012f//0.0008f//0.0003f//0.00025f
#define RC_TO_PITCH     0.00015f

/* 修改鼠标的参数值 */
#define MOUSE_X_RADIO 0.0004f//0.01f//0.01f
#define MOUSE_Y_RADIO 0.0001f//0.005f//0.01f
